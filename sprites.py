...
class spritesheet(object):
    ...
    def load_strip(self, rect, image_count, colorkey = None, mirror = False):
        "Loads a strip of images and returns them as a list"
        tups = [(rect[0]+rect[2]*x, rect[1], rect[2], rect[3])
                for x in range(image_count)]
        return self.images_at(tups, colorkey, mirror)
...
class SpriteStripAnim(object):
    ...
    """
    def __init__(self, filename, rect, count, colorkey=None, loop=False, frames=1, mirror=False):
        ...
        self.images = ss.load_strip(rect, count, colorkey, mirror)
        self.i = 0
        self.loop = loop
        self.frames = frames
        self.f = frames
